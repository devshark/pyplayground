...
##    regex = re.compile('big',re.IGNORECASE)
##    regex = re.compile('[A-Z]{3}[a-z]{1}[A-Z]{3}')
##    regex = re.compile('big',re.IGNORECASE)
##    regex = re.compile('[\ ][A-Z]{3}[a-z][A-Z]{3}[\ ]')

    for chr in regex.findall(mess):
        print chr
##        if chr[0:3]==chr[4:7]:
##            print chr[0:3]
##            print chr[4:7]
...
##    print '\n\r'.join(regex.findall(mess))
##    print 'Total of '+ str( len( regex.findall(mess) ) )
